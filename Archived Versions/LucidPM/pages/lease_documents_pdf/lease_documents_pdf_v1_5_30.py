...
def _split_blocks(text: str) -> list[str]:
    ...
    # This preserves intentional paragraph separation in long clauses like
    # Tenant Responsibilities instead of collapsing the whole section into one
    # dense paragraph. Inline ReportLab markup such as <b>...</b> remains intact.
