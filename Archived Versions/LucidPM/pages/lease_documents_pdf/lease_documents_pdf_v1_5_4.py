...
Patched 5/3/2026:
- v1.5.4: normalized soft-wrapped legal paragraphs for stronger justification and improved clause spacing fallback styles.
...
try:
    ...
    LEASE_STYLES = {
        "CLAUSE_BODY": ParagraphStyle("ClauseBody", fontName="Times-Roman", fontSize=10, leading=13, alignment=4, leftIndent=18, firstLineIndent=-18, spaceAfter=14),
        "ARTICLE_HEADER": ParagraphStyle("ArticleHeader", fontName="Times-Bold", fontSize=10, leading=12, keepWithNext=True, spaceBefore=14, spaceAfter=10),
        ...
        "INDENTED_BODY": ParagraphStyle("IndentedBody", fontName="Times-Roman", fontSize=10, leading=13, alignment=4, leftIndent=36, firstLineIndent=-18, spaceAfter=14),
