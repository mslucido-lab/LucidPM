...
class TenantState(AppState):
    ...
    def load_leases(self):
        rows = run_query(
            ...
            "l.LeaseStart, l.LeaseEnd, ISNULL(l.LeaseStatus, 'Active') AS LeaseStatus, l.LeaseTerminationDate, l.RentAmount "
            "FROM Leases l "
    ...
    def select_lease(self, lease_id: int):
        ...
        rows = run_query(
            ...
            "l.LeaseStart, l.LeaseEnd, ISNULL(l.LeaseStatus, 'Active') AS LeaseStatus, l.LeaseTerminationDate, l.RentAmount, l.DepositAmount, "
    ...
    def save_lease(self):
        ...
        if self.lease_mode == "edit":
            run_exec(
                ...
                "LeaseStart=?, LeaseEnd=?, LeaseStatus=?, LeaseTerminationDate=?, RentAmount=?, DepositAmount=?, RentDueDay=?, "
                "NextDueDate=?, ShowAnniversaries=? WHERE LeaseID=?",
                (prop_id, suite_id, lease_type_id, lease_term_type_id,
                 lease_start, lease_end, self.l_status, termination_date, rent, deposit, due_day,
            ...
            run_exec(
                ...
                "LeaseStart, LeaseEnd, LeaseStatus, LeaseTerminationDate, RentAmount, DepositAmount, RentDueDay, NextDueDate, ShowAnniversaries) "
                "VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
