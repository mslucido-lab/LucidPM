...
class RentRollState(AppState):
        ...
        for s in suites:
            ...
            if active_match is None and holdover_match is None:
                ...
                output_rows.append(RentRollRow(
                    ...
                    rental_rate=fmt_money(active_match.get("RentAmount")),
                ...
                output_rows.append(RentRollRow(
                    ...
                    rental_rate=fmt_money(holdover_match.get("RentAmount")),
    ...
    def pdf_download_url(self) -> str:
        """Builds the PDF endpoint URL with current filter state as query params."""
        base = "/api/rent-roll-pdf"
        params = f"?as_of={self.as_of_date}&property={self.property_filter}&basis={self.basis}"
        return base + params
