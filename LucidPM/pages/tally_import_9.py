...
NOTE_FIELD_DEFS: list[tuple[str, tuple[str, ...], str]] = [
    ...
    _note_field("Address", "address", "homeaddress", "currentaddress"),
    ...
    _note_field("Trade reference 1", "tradereference1", "tradereference1name", "reference1name"),
    _note_field("Trade reference 2", "tradereference2", "tradereference2name", "reference2name"),
    _note_field("Trade reference 3", "tradereference3", "tradereference3name", "reference3name"),
