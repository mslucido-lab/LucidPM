...
def _build_application_report_pdf(
    ...
    def row2(l1, v1, l2, v2):
        a = str(v1 or "").strip() or "________________"
        b = str(v2 or "").strip() or "________________"
    ...
    s.append(Paragraph(fld("Date", ""), body)); s.append(Spacer(1,5))
    ...
    s.append(Paragraph(row2("Date of Birth", dob_d, "Address", fields.get("address","")), body)); s.append(Spacer(1,10))
    ...
    s.append(Paragraph(fld("Present Address", fields.get("address","")), body)); s.append(Spacer(1,5))
    ...
    for i, k in enumerate(["trade_ref_1","trade_ref_2","trade_ref_3"], 1):
            ...
            rx.hstack(
                ...
                rx.cond(
                    ...
                    rx.link(
                        ...
                        href="http://localhost:8000/api/application-report-pdf?tenant_id="
                             + TenantState.tenant_id.to_string()
                             + "&db=" + TenantState.db,
                        is_external=True,
                    ),
                    rx.fragment(),
