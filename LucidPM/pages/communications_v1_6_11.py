...
# Page width constant — sidebar (220px) + page_shell padding (32px each side = 64px)
# Update this if sidebar width or page_shell padding changes
FULL_PAGE_WIDTH = "calc(100vw - 284px)"
