...
# VERSION: 3.0.12
# - Added tokenization helpers to Parse & Section Text Clause mode.
# - Available token chips now append {{TokenName}} into the clause text area.
# - Parse tab now shows detected tokens and a clickable token reference while creating clauses.
#
