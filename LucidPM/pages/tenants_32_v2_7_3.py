...
class TenantState(AppState):
    ...
    def open_compose_email(self):
        """Pre-populate To address from primary contact email and open modal."""
        self.compose_error = ""
        self.compose_success = ""
        ...
        rows = run_query(
            "SELECT TOP 1 Email1 FROM dbo.Contacts "
            "WHERE TenantID = ? AND IsPrimary = 1 "
        ...
        self.compose_to = str(rows[0].get("Email1") or "") if rows else ""
        self.compose_email_open = True
