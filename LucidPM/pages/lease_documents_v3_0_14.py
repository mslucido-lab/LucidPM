...
class LeaseDocumentState(AppState):
    ...
    def create_section(self):
        ...
        has_source_document = int(self.selected_source_document_id or 0) > 0
        ...
        try:
            ...
            root = self.storage_root.strip() or DEFAULT_DOCUMENT_ROOT
            if is_text_clause:
                section_path = str(self.selected_source_path or "").strip() or None
    ...
    def _save_text_clause_section(self, draft: DraftClauseRow) -> int:
        has_source_document = int(self.selected_source_document_id or 0) > 0
        source_path = str(self.selected_source_path or "").strip() or None
        root = self.storage_root.strip() or DEFAULT_DOCUMENT_ROOT
