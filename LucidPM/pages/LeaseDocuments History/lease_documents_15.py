...
# VERSION: 2.6.3 - adds tokenized Content editor for lease document pieces.
...
class LeaseDocumentState(AppState):
    ...
    def _load_pieces(self):
        ...
        rows = run_query(
            ...
            "SortOrder, IsReusable, IsActive, CASE WHEN NULLIF(LTRIM(RTRIM(ISNULL(Content,''))), '') IS NULL THEN 'No' ELSE 'Yes' END AS HasContent FROM LeaseDocumentPieces "
