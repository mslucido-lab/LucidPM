...
(function() {
    function bindLeaseDocResizer(leftId, handleId, storageKey, defaultWidth) {
        var leftPanel = document.getElementById(leftId);
        var handle = document.getElementById(handleId);
        if (!leftPanel || !handle) {
            setTimeout(function() { bindLeaseDocResizer(leftId, handleId, storageKey, defaultWidth); }, 300);
            return;
        }
        ...
        if (savedWidth) {
            ...
            leftPanel.style.minWidth = savedWidth + 'px';
        } else if (defaultWidth) {
            leftPanel.style.width = defaultWidth + 'px';
            leftPanel.style.minWidth = defaultWidth + 'px';
        }
        ...
        document.addEventListener('mousemove', function(e) {
            ...
            var newWidth = Math.min(Math.max(startWidth + delta, 220), maxWidth);
        ...
        document.addEventListener('mouseup', function() {
            ...
            localStorage.setItem(storageKey, String(leftPanel.offsetWidth));
        });
    }

    bindLeaseDocResizer('lease-doc-load-left-panel', 'lease-doc-load-resizer', 'lucidpm_lease_doc_load_left_width', 360);
    bindLeaseDocResizer('lease-doc-template-left-panel', 'lease-doc-template-resizer', 'lucidpm_lease_doc_template_left_width', 420);
})();
"""
