...
class LeaseDocumentState(AppState):
        ...
        if not label:
            ...
            if rows:
                ...
                template_row = LeaseTemplateRow(
                    template_id=int(r.get("LeaseTemplateID") or tid),
                ...
                if not any(int(t.template_id or 0) == tid for t in self.lease_templates):
    ...
    def set_selected_template_label(self, label: str):
        ...
        elif int(self.selected_template_id or 0) > 0:
