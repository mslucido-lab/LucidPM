...
# VERSION: 2.6.8 - UI-only naming cleanup: source documents, sections, and package templates.
    ...
    def delete_piece(self, piece_id: int):
        ...
        try:
            ...
            if used:
                ...
                self.form_success = "Section is used by a generated package, so it was archived instead of deleted."
            else:
