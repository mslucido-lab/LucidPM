...
Version: v1.2.5
Fixes responsive_card passthrough props compile issue and keeps full-width Admin Settings layout.
...
def responsive_card(*children, **props) -> rx.Component:
    """Full-width card wrapper that still allows normal rx.card props."""
    style = {
        "box_sizing": "border-box",
        "max_width": "100%",
        "overflow_x": "hidden",
    }
    provided_style = props.pop("style", None)
    if isinstance(provided_style, dict):
        style.update(provided_style)
    return rx.card(
        *children,
            ...
            rx.vstack(
                ...
                rx.hstack(
                    ...
                    rx.vstack(
                        ...
                        width="100%", max_width="120px", min_width="90px",
                    ),
                    rx.vstack(
                ...
                rx.hstack(
                    ...
                    rx.vstack(
                        ...
                        width="100%", max_width="220px", min_width="160px",
                    ),
                    width="100%", spacing="4", wrap="wrap",
                ),
                rx.hstack(
            ...
            rx.vstack(
                ...
                rx.hstack(
                    ...
                    rx.vstack(
                        ...
                        width="100%", max_width="340px", min_width="240px",
                    ),
                    width="100%", spacing="4", wrap="wrap", align="end",
                ),
                rx.hstack(
