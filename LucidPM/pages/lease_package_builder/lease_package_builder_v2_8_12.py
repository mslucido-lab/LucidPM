    ...
    def select_generated_package(self, generated_id: int):
        ...
        self.generated_package_sections = [
            GeneratedPackageSectionRow(
                ...
                dirty="Yes" if row.get("IsDirty") else "No",
            )
...
def generated_section_row(row: GeneratedPackageSectionRow) -> rx.Component:
    return rx.table.row(
        ...
        rx.table.cell(rx.badge(row.dirty, color_scheme=rx.cond(row.dirty == "Yes", "orange", "gray"), variant="soft")),
                    ...
                    rx.table.root(
                        rx.table.header(
                            rx.table.row(
                                ...
                                rx.table.column_header_cell("Dirty"),
                            )
                        ),
