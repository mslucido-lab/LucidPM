...
def _schedule_table_flowable(lines: list[str]):
    ...
    if has_two_column_rows:
        ...
        # Grouped 3+ year schedules are narrower than monthly 4-column schedules.
        # Do not wrap them in the indented outer table, because that visually
        # pulls the schedule left. Center the grouped table directly.
