...
# v2.8.7 - Code review fixes: optional empty tokens allowed, audit warnings visible, template required for generation, cleanup dead code.
            ...
            if generated_id:
                ...
                for idx, p in enumerate(selected, start=1):
                    ...
                    try:
                        ...
                        self.form_success += f" (Audit warning: {audit_ex})"
