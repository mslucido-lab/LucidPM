...
# v2.7.1 - Fix #2: merge preview now renders tokenized content one section at a time.
                ...
                if self.selected_package_template_id > 0 and self.template_sections:
                    for section in self.template_sections:
                        ...
                        run_exec(
                            ...
                            "(LeaseGeneratedDocumentID, LeaseTemplateSectionID, SortOrder, IsIncluded, PieceID, IsDirty) "
                            "VALUES (?, ?, ?, ?, ?, 0)",
                            (
                                generated_id,
