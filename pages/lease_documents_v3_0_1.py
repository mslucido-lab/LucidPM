...
class LeaseDocumentState(AppState):
    ...
    def save_section_content(self):
        ...
        try:
            run_exec(
                "UPDATE LeaseDocumentSections SET ClauseTag=?, ArticleNumber=?, DisplayLabel=?, Content=? WHERE LeaseDocumentSectionID = ?",
                (
        ...
        try:
            ...
            if current_edit_id:
                ...
                run_exec(
                    ...
                    "ClauseTag=?, ArticleNumber=?, DisplayLabel=?, Content=? "
                ...
                run_exec(
                    ...
                    "StoredFilePath, StorageRoot, RelativePath, SortOrder, IsReusable, IsActive, ClauseTag, ArticleNumber, DisplayLabel, Content) "
                    "VALUES (?, NULL, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
                    (
