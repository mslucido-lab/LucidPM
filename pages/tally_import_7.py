...
def _build_import_notes(row_norm: dict) -> str:
    mapping = [
        ...
        ("Contact name",       pick(row_norm, "contactname")),
        ...
        ("Emergency contact name", pick(row_norm, "emergencycontactname", "emergencyname")),
        ("Emergency contact phone", pick(row_norm, "emergencycontactphone", "emergencyphone")),
        ("Emergency contact email", pick(row_norm, "emergencycontactemail", "emergencyemail")),
        ("When established",      pick(row_norm, "whenestablished", "yearestablished", "businessestablished")),
        ("Form of business",      pick(row_norm, "formofbusiness", "businesstype", "businessstructure")),
