...
class TenantState(AppState):
    ...
    def load_leases(self):
        rows = run_query(
            ...
            "l.LeaseStart, l.LeaseEnd, ISNULL(l.LeaseStatus, 'Active') AS LeaseStatus, l.RentAmount "
            "FROM Leases l "
    ...
    def select_lease(self, lease_id: int):
        ...
        rows = run_query(
            ...
            "l.LeaseStart, l.LeaseEnd, ISNULL(l.LeaseStatus, 'Active') AS LeaseStatus, l.RentAmount, l.DepositAmount, "
    ...
    def save_lease(self):
        ...
        if self.lease_mode == "edit":
            run_exec(
                ...
                "LeaseStart=?, LeaseEnd=?, LeaseStatus=?, RentAmount=?, DepositAmount=?, RentDueDay=?, "
                "NextDueDate=?, ShowAnniversaries=? WHERE LeaseID=?",
                (prop_id, suite_id, lease_type_id, lease_term_type_id,
                 lease_start, lease_end, self.l_status, rent, deposit, due_day,
            ...
            run_exec(
                ...
                "LeaseStart, LeaseEnd, LeaseStatus, RentAmount, DepositAmount, RentDueDay, NextDueDate, ShowAnniversaries) "
                "VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)",
