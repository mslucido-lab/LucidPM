...
# VERSION: 2.7.4 - Pipeline scope: section token visibility and naming cleanup.
...
class LeaseDocumentState(AppState):
    ...
    def _load_pieces(self):
        ...
        self.pieces = [
            PieceRow(
                piece_id=int(r["LeaseDocumentSectionID"]),
    ...
    def edit_piece(self, piece_id: int):
        ...
        if not rows:
            ...
            return
        r = rows[0]
        self.editing_piece_id = int(r["LeaseDocumentSectionID"])
        self.p_piece_type = str(r.get("SectionType") or "Base Lease")
        self.p_piece_name = str(r.get("SectionName") or "")
    ...
    def delete_piece(self, piece_id: int):
        ...
        try:
            ...
            if used or used_in_package_sections:
                ...
                run_exec("DELETE FROM LeaseDocumentSections WHERE LeaseDocumentSectionID = ?", (piece_id_int,), db=self.db)
    ...
    def _load_reusable_piece_options(self):
        ...
        for r in rows:
            ...
            name = str(r.get("SectionName") or "").strip() or f"Piece {pid}"
    ...
    def _load_template_sections(self):
        ...
        self.lease_template_sections = [
            LeaseTemplateSectionRow(
                ...
                default_piece_label=self._piece_label_for_id(r.get("DefaultSectionID")),
