    ...
    return rx.vstack(
        ...
        rx.hstack(
            rx.box(
                ...
                style={"width": "30%", "min_width": "240px", "max_width": "55%", "resize": "horizontal", "overflow": "auto", "height": "calc(100vh - 260px)", "background": "#ffffff", "border": "1px solid #e5e7eb", "border_radius": "12px", "padding": "14px"},
            ),
            rx.box(style={"width": "6px", "align_self": "stretch", "cursor": "col-resize", "background": "linear-gradient(90deg, transparent 0, #d1d5db 45%, #d1d5db 55%, transparent 100%)", "border_radius": "999px"}),
            rx.box(
                rx.vstack(
                    rx.card(
                        rx.vstack(
...
def _tab_templates() -> rx.Component:
    ...
    left_panel = rx.box(
        ...
        style={"width": "35%", "min_width": "260px", "max_width": "60%", "resize": "horizontal", "overflow": "auto", "height": "calc(100vh - 260px)", "background": "#ffffff", "border": "1px solid #e5e7eb", "border_radius": "12px", "padding": "14px"},
    )
    right_panel = rx.box(
        rx.vstack(
