...
# - Load tab now shows all reusable/active sections across all source documents, not only the selected source.
                ...
                rx.vstack(
                    ...
                    rx.card(
                        rx.vstack(
                            ...
                            rx.text("This is the combined reusable section library across all active source documents. Source documents can have overlapping page numbers because each PDF starts at page 1.", size="2", color="#666"),
                            rx.cond(
                                LeaseDocumentState.all_sections.length() > 0,
                                rx.table.root(
                                ...
                                rx.callout.root(rx.callout.text("No reusable sections have been created yet."), color_scheme="gray", width="100%"),
                            ),
                            spacing="3", width="100%", align_items="start",
                        ), width="100%",
                    ),
