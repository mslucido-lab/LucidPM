                ...
                rx.vstack(
                    ...
                    rx.card(
                        rx.vstack(
                            ...
                            rx.text("These are the sections currently saved from the selected source document.", size="2", color="#666"),
                            rx.cond(
                                LeaseDocumentState.selected_source_document_id > 0,
                                rx.cond(
                                    LeaseDocumentState.sections.length() > 0,
                                    rx.table.root(
                                        rx.table.header(rx.table.row(rx.table.column_header_cell("Sort"), rx.table.column_header_cell("Type"), rx.table.column_header_cell("Code"), rx.table.column_header_cell("Name"), rx.table.column_header_cell("Pages"), rx.table.column_header_cell("Reusable"), rx.table.column_header_cell("Active"))),
                                        rx.table.body(rx.foreach(LeaseDocumentState.sections, load_tab_section_row)),
                                        width="100%",
                                    ),
                                    rx.callout.root(rx.callout.text("No sections have been created for this source document yet."), color_scheme="gray", width="100%"),
                                ),
                                rx.callout.root(rx.callout.text("Select a source document to view its sections."), color_scheme="gray", width="100%"),
                            ),
                            spacing="3", width="100%", align_items="start",
                        ), width="100%",
                    ),
