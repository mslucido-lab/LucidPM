...
def _schedule_table_flowable(lines: list[str]):
    ...
    if not has_two_column_rows:
        # The grouped schedule table is narrow enough that the nested outer table
        # can make it appear left-biased. Return it directly with hAlign=CENTER
        # so ReportLab centers the two-column block in the page frame.
