...
class PropertyState(AppState):
    ...
    form_error: str = ""
    form_success: str = ""
    state_options: list[str] = US_STATES
    ...
    return rx.vstack(
        ...
        rx.grid(
            ...
            rx.vstack(
                ...
                rx.select(PropertyState.state_options, value=PropertyState.f_state,
                          on_change=PropertyState.set_f_state, size="2", width="100%"),
                spacing="1", width="100%",
            ),
            rx.vstack(
