...
def _build_address_block(row_norm: dict) -> str:
    line1 = pick(row_norm, "addressline1", "address1", "streetaddress", "street")
    city = pick(row_norm, "city")
    state = pick(row_norm, "state")
    zip_code = pick(row_norm, "zipcode", "zip", "postalcode")
