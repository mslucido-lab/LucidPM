...
def _keep_special_conditions_with_first_child(story: list) -> list:
    ...
    while i < len(story):
        ...
        if _style_name(item) == "ArticleHeader":
            ...
            if next_style in ("IndentedBody", "IndentedChildBody"):
...
def _story_for_text_sections(section_texts: Sequence[str]) -> list:
    ...
    return _keep_special_conditions_with_first_child(story)
