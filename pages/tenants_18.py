...
def _build_application_report_pdf(
    ...
    s.append(Paragraph(row2("Annual Sales", fields.get("annual_sales",""), "Name of your bank", fields.get("bank_name","") or fields.get("dun_bradstreet","")), body)); s.append(Spacer(1,5))
