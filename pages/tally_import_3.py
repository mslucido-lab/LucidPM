...
def _build_full_name(row_norm: dict) -> str:
    """
    Build full name from Tally fields. Tries contact name, individual name,
    then falls back to combining first + last name fields.
    """
    # Try direct full-name fields first
    full = pick(row_norm, "contactname", "individualname", "fullname", "applicantname", "name")
    if full:
        return full
    # Fall back to first + last combination
