...
v2.5.1 — Added editable rent schedule rows:
...
class TenantState(AppState):
    ...
    def _load_lease_lookups(self):
        ...
        rows = run_query(
            ...
            "FROM LeaseRentIncreaseTypes ORDER BY DisplayOrder, IncreaseTypeName",
            db=self.db,
        )
    ...
    def new_rent_schedule_row(self):
        ...
        self.rs_increase_type = (
            "Base" if "Base" in self.increase_type_names
            else (self.increase_type_names[0] if self.increase_type_names else "")
        )
        self.rs_notes = ""
